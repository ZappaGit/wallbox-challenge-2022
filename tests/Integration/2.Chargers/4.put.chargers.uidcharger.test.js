...
describe("[4] PUT -/charger/uidchager operation requests", () => {
  ...
  it("200 - update user mail  -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
      .set("Content-Type", "application/json")
      .set("authorization", tokenAdmin)
  ...
  it("200 - update user password -  -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("200 - update user role to admin-  -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("200 - update user role to user-  -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("409 - update user mail - Email already in use (same mail) -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("401 - update user mail - Wrong email or password (same mail) -for admin over user /chargers/{{uidUser}}", (done) => {
    request
      .put("/chargers/" + uidUser)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  //   it("200 - OK - message User Updated - for admin over admin  /chargers/{{uidAdmin}}", (done) => {
  //     request
  //       .put("/chargers/" + uidAdmin)
  //       .set("accept", "application/json")
  //       .set("Content-Type", "application/json")
