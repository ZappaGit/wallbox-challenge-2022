...
describe("[11] PUT -/users/uiduser operation requests", () => {
  ...
  it("400 - Unexpected string admin over /users/{{miUser}}", (done) => {
    request
      .put("/users/" + miUser.uid)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("200 - User updated  -for admin over /users/{{uidUser}}", (done) => {
    request
      .put("/users/" + miUser.uid)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("409 - update user mail - Email already in use (same mail) -for admin over /users/{{uidUser}}", (done) => {
    request
      .put("/users/" + miUser.uid)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
  ...
  it("400 - update user mail - Wrong email or password (same mail) -for admin over /users/{{uidUser}}", (done) => {
    request
      .put("/users/" + miUser.uid)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
      .set("Content-Type", "application/json")
      .set("authorization", tokenAdmin)
      .send(config.user_update_wrong_password)
      .end(function (err, res) {
        //console.log(res);
        expect(res).to.have.status(400);
        expect(res).to.have.header(
  ...
  it("403 - Cannot access that resource - for user over another user  /users/{{uidUser}}", (done) => {
    request
      .put("/users/" + miUser.uid)
      .set("accept", "application/json")
      .set("Content-Type", "application/json")
